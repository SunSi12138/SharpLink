...
public static class Program
{
    ...
    private static void AssertGenerationControlPackageSurface()
    {
        ...
        if (inventory.Generations.Length != 1 || inventory.Generations[0].State != SharpLinkGenerationState.Active)
