...
the target assembly to remain absent. This prevents an old Generator from producing an API 3 or API 4
shape that could be mistaken for the current API 5 through consumer-side constants.
