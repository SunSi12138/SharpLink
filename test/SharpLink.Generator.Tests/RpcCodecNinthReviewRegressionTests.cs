...
""");
        ...
        Ensure(
            ...
            "Nullable<RpcSerializableStruct> must model the runtime raw Nullable<T> layout rather than composing RpcMember/DTO semantics into the selected codec identity");
