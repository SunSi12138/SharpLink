...
result = {
    "experiment": "deadline-bearing-registration-completion-fresh-page-marks",
    "gate_percent": 3.0,
    "rounds": rounds,
...
if not passed:
    raise SystemExit("fresh-page deadline-bearing PendingRequestTable maintenance missed the predeclared gate")
PY
