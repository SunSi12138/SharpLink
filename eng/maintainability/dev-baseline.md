...
| --- | ---: | ---: | ---: | ---: | ---: |
| source | 293 | 70543 | 3226 | 80 | 69 |
| test | 366 | 127214 | 6865 | 73 | 37 |
...
| `src/SharpLink.Generator/RpcGenerator.Analysis.cs` | 1655 | 79 | 132 | 24 | 0 |
...
| `src/SharpLink.Generator/RpcGenerator.ContractManifest.cs` | 1098 | 19 | 281 | 47 | 4 |
...
| `src/SharpLink.Client/SharpLinkMultiClusterClient.cs` | 800 | 30 | 98 | 21 | 2 |
...
| `test/SharpLink.IntegrationTests/IntegrationBehaviorTests.cs` | 2692 | 169 | 86 | 19 | 0 |
...
| `test/SharpLink.IntegrationTests/TransportConnectionIntegrationTests.cs` | 2075 | 105 | 87 | 8 | 0 |
...
| `test/SharpLink.ChaosTests/Program.cs` | 1540 | 68 | 452 | 28 | 20 |
| `test/SharpLink.LoadTest/Program.cs` | 1506 | 53 | 337 | 70 | 18 |
| `test/SharpLink.IntegrationTests/DynamicEndpointIntegrationTests.cs` | 1401 | 68 | 144 | 9 | 2 |
...
| `test/SharpLink.IntegrationTests/SharedMemoryTransportConnectionIntegrationTests.cs` | 1330 | 49 | 81 | 12 | 9 |
| `test/SharpLink.Benchmarks/SendPumpIsolationEvidenceRunner.cs` | 1318 | 57 | 143 | 15 | 13 |
| `test/SharpLink.Benchmarks/DecodeExecutionPhase0EvidenceRunner.cs` | 1312 | 59 | 132 | 21 | 12 |
| `test/SharpLink.IntegrationTests/InterceptorIntegrationTests.cs` | 1289 | 104 | 54 | 6 | 0 |
| `test/SharpLink.UnitTests/Runtime/RpcSessionLifecycleTests.cs` | 1281 | 52 | 103 | 14 | 5 |
| `test/SharpLink.UnitTests/Runtime/StreamManagerTests.cs` | 1252 | 66 | 61 | 6 | 3 |
| `test/SharpLink.UnitTests/Runtime/RequestManagerTests.cs` | 1095 | 64 | 69 | 6 | 5 |
| `test/SharpLink.IntegrationTests/RpcChannelCallShapeIntegrationTests.cs` | 1056 | 213 | 114 | 7 | 1 |
...
| test | `MeasureAsync` | `test/SharpLink.Benchmarks/DecodeExecutorBlockedWriterCancellationEvidenceRunner.cs:47` | 179 | 37 |
...
| source | `DispatchRpcWithPersistentDecodeAsync` | `src/SharpLink.Server/SharpLinkServer.PersistentDecodeDispatch.cs:5` | 169 | 7 |
| source | `AppendStubDispatchCases` | `src/SharpLink.Generator/RpcGenerator.StubEmitter.cs:262` | 154 | 29 |
...
| source | `ContinueRpcDispatch` | `src/SharpLink.Server/SharpLinkServer.InvocationContinuation.cs:10` | 368 | 28 |
| source | `RunAsync` | `src/SharpLink.Runtime/RpcSession.SendPump.cs:211` | 170 | 28 |
| source | `HasRequiredWireFormatIds` | `src/SharpLink.Generator/RpcGenerator.ContractManifest.cs:798` | 32 | 28 |
| source | `DispatchRpcAsync` | `src/SharpLink.Server/SharpLinkServer.InvocationDispatch.cs:5` | 335 | 27 |
## Metric definitions
...
- Cyclomatic complexity: 1 plus if/loop/catch/case/switch-expression-arm/conditional-expression/&&/|| decision points inside the method body.
