...
{
    private static string GenerateProxy(string manifestTypeName, RpcInterfaceModel model)
    {
        var body = new StringBuilder();
        AppendProxyClassBody(body, model);
    ...
    private static string GenerateProxyHelpers(RpcInterfaceModel model)
    {
    ...
    private static void AppendProxyClassBody(StringBuilder sb, RpcInterfaceModel model)
    {
