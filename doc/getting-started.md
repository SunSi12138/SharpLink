...
```xml
<ItemGroup>
  <PackageReference Include="SharpLink.Sdk" Version="1.0.0-rc5" />
  <PackageReference Include="SharpLink.Client" Version="1.0.0-rc5" />
  <PackageReference Include="SharpLink.Server" Version="1.0.0-rc5" />
</ItemGroup>
```
