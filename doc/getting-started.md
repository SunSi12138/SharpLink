...
```xml
<ItemGroup>
  <PackageReference Include="SharpLink.Sdk" Version="0.9.2" />
  <PackageReference Include="SharpLink.Client" Version="0.9.2" />
  <PackageReference Include="SharpLink.Server" Version="0.9.2" />
</ItemGroup>
```
